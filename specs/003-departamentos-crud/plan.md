...
**Branch**: `003-departamentos-crud` | **Date**: 2026-03-19 | **Spec**: `/specs/003-departamentos-crud/spec.md`
...
**Structure Decision**: Se mantiene la estructura monolítica backend existente en `DSW02-Practica01`, agregando artefactos de feature en `specs/003-departamentos-crud` y extendiendo capas `domain/application/api/infrastructure` para el agregado `Departamento` y su relación con `Empleado`.
