...
**Feature Branch**: `001-angular-frontend-e2e`  
...
- Que ocurre cuando el backend no esta disponible durante el login o una operacion de gestion? El sistema debe mostrar error recuperable sin bloquear permanentemente la interfaz.
...
- **FR-002**: El sistema MUST validar credenciales de login contra el endpoint de autenticacion existente del backend.
...
- **FR-012**: Todas las solicitudes a la API protegida MUST incluir autenticacion HTTP Basic con credenciales validas.
